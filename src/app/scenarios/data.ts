...
export const scenarios: Scenario[] = [
  // ===== Existing Scenarios =====
  {
    ...
    requirements: {
      performance: [
        "Oxygen transmission rate < 2cc",
        "Water vapor transmission rate < 1g",
        "Light blocking > 99%",
      ],
  ...
  },
  {
    ...
    challenges: [
      "Petroleum-based",
      "Microplastic issues",
      "Bottle-to-bottle recycling rate",
    ],
  },
  ...
  },
  {
    ...
    icon: "🍛",
    description:
      "High-barrier food packaging resistant to high temperature/pressure sterilization",
    currentMaterial: {
      composition: "PET/Al/CPP-R",
      properties: [
        "Retort resistance (135°C)",
        "Ultra-high barrier",
        "Light blocking",
        "Sterility",
      ],
  ...
  },
  {
    ...
    icon: "🍫",
    description:
      'Individual wrapping film for confectionery like "Takenoko no Sato"',
    currentMaterial: {
      composition: "OPP/VMPET/CPP",
      properties: [
        "Twist wrapping capability",
        "Moisture proof",
        "Aroma retention",
        "Glossy finish",
      ],
    ...
    requirements: {
      ...
      sustainability: [
        "Aluminum metallization-free",
        "Paper conversion challenge",
